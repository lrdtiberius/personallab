...
<button class='action secondary' onclick="start('/api/sync?analyze_new=true&limit=25')">Max. 25 neue analysieren</button>
...
function one(){let id=document.querySelector('#doc').value;if(id)start('/api/analyze/'+id+'?repair_ocr=true')}
